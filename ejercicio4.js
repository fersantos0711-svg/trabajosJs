...
//1. 
//Declara una variable llamada verdadero y asígnale un dato de tipo 
...
//1. 
//Realiza una operación matemática usando la variable número, por 
...
//Declaración de Variables:
let verdadero = true;
let texto = "Quien me jalo.";
let numero = 42;
let nada = null;
//Operaciones y Validaciones:
//1. Operación matemática       
let resultadoSuma = numero + 8; // Suma 8 al valor de la variable numero
console.log("Resultado de la suma:", resultadoSuma);
//2. Concatenación de strings
let mensajeCompleto = texto + "  mi cabeio?";
console.log("Mensaje completo:", mensajeCompleto);
//3. Verificación de la variable booleano       
if (verdadero) {
    console.log("La variable 'verdadero' es true.");
} else {
    console.log("La variable 'verdadero' es false.");
}   
//4. Verificación de la variable nada
if (nada === null) {
